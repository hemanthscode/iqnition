...
// Load Chart.js and jsPDF from node_modules using script tags (more reliable)
...
Promise.all([
  ...
  // Fallback: continue without libraries
  initializeApp();
});

// Import our modules (these work fine)
...
// Make CSRF functions globally available IMMEDIATELY
